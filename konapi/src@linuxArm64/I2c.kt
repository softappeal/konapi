...
/*
    ...
    curl -o konapi/cinterop/headers/i2c/smbus.h 'https://git.kernel.org/pub/scm/utils/i2c-tools/i2c-tools.git/plain/include/i2c/smbus.h?h=v4.4'
    scp me@pi0:/usr/include/linux/i2c-dev.h konapi/cinterop/headers/linux

    ldd /usr/sbin/i2cdetect
        libi2c.so.0 => /lib/aarch64-linux-gnu/libi2c.so.0
    scp me@pi0:/lib/aarch64-linux-gnu/libi2c.so.0 konapi/cinterop/libs/libi2c.so
 */
